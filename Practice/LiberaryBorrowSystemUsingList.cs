...
public class Utility
{
    public void AddBorrowRecord(string studentName, string bookTittle, string category, int borrowDay)
    {
        ...
        Program.MainList.Add(borrowRecord);
    ...
    public Dictionary<string, List<BorrowRecord>> GroupRecordByCategory()
    {
        ...
        foreach (var record in Program.MainList)
        {
    ...
    public BorrowRecord LongestBorrowDay()
    {
        ...
        foreach (var item in Program.MainList)
        {
            if (longestBorrowRecord == null || item.BorrowDay > longestBorrowRecord.BorrowDay)
            {
                longestBorrowRecord = item;
            }
        }
    ...
    public List<BorrowRecord> FilterRecordByMinimumBorrowDay(int minBorrowDay)
    {
        ...
        foreach (var item in Program.MainList)
        {
            if (item.BorrowDay >= minBorrowDay)
            {
                result.Add(item);
            }
        }
...
{
    public static List<BorrowRecord> MainList = new List<BorrowRecord>();
